...
;
  warp = {
  meta = {
    sha256 = "0d3gqliksqv63hm1pk06bni4z4yy7076g0h58fy0ci5xc4bbcf1r";
    url = "https://hackage.haskell.org";
    ver = "3.4.13.1";
  };
...
mkDerivation {
  pname = "warp";
  version = "3.4.13.1";
  src = /nix/store/3nrkavzvnv4k11n5bywnj5pwb03rr0wm-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "prelate";
  version = "0.5.0.0";
  src = /nix/store/qbf8dbn2if5xzpkf951vx3i0c7i85kcz-source;
  libraryHaskellDepends = [
    aeson base exon extra generic-lens incipit microlens microlens-ghc
    polysemy-chronos polysemy-conc polysemy-log polysemy-process
    polysemy-resume polysemy-time template-haskell
