...
latest = {
  auto-update = {
  meta = {
    sha256 = "0sp25j3fcgmfr2zv1ccg1id1iynj3azinjg23g0vy1m1m7gnmkzi";
    ver = "0.2.6";
  };
  drv = { mkDerivation, base, exceptions, hspec, hspec-discover, HUnit, lib
, retry, stm
}:
mkDerivation {
  pname = "auto-update";
  version = "0.2.6";
  src = /nix/store/6wffgx42ilgw5ghdav7cpf3rpghsl688-source;
...
;
  http2 = {
  meta = {
    sha256 = "19lzz6y1rzsbyfswfp9zg9gszmimvfib72dg60x6f19lvmnziga8";
    ver = "5.3.9";
  };
...
mkDerivation {
  pname = "http2";
  version = "5.3.9";
  src = /nix/store/wvwbd5gx7qbyrk8w2kizpdmm5sr4bqlx-source;
  isLibrary = true;
  isExecutable = true;
  libraryHaskellDepends = [
...
;
  network-control = {
  meta = {
    sha256 = "00kb50jj14661p0bfb2hgzrq93z9rjch082hp6wda65hvgxfz289";
    ver = "0.1.4";
  };
  drv = { mkDerivation, base, hspec, hspec-discover, lib, pretty-simple
, psqueues, QuickCheck, text, unix-time
}:
mkDerivation {
  pname = "network-control";
  version = "0.1.4";
  src = /nix/store/ppz9b9mwmv2ssbs54b5wysmk1gh9rii7-source;
...
mkDerivation {
  ...
  version = "0.20.2";
  src = /nix/store/da6gxri57fy2mpk8bdsx57nrw6zl0qny-source;
  libraryHaskellDepends = [
...
;
  time-manager = {
  meta = {
    sha256 = "1ja8pimvy07b05ifkrg6q0lzs3kh0k2dmncwjdxl81199r559vf5";
    ver = "0.2.2";
  };
...
mkDerivation {
  pname = "time-manager";
  version = "0.2.2";
  src = /nix/store/cii9mf9srkbpi5l34ysgrwrl2zpcfs4v-source;
...
mkDerivation {
  pname = "wai-extra";
  version = "3.1.17";
  src = /nix/store/7jbhd188681dkrrvwrgl1drjrs8da4kn-source;
  isLibrary = true;
  isExecutable = true;
  libraryHaskellDepends = [
...
;
  warp = {
  meta = {
    sha256 = "1bc3g094d2j0w6wkh1g1hw0br3kcl4v3mczmyxhq2rcpkzwqjwa1";
    ver = "3.4.7";
  };
...
mkDerivation {
  pname = "warp";
  version = "3.4.7";
  src = /nix/store/2ddq7ma8w9i9g1vsq2w6lvcz395xk1wi-source;
  libraryHaskellDepends = [
...
mkDerivation {
  ...
  version = "1.1.0.0";
  src = /nix/store/1wlhqjwn2gasv7shn3l6rydpnklv4pzf-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "byteslice";
  version = "0.2.14.0";
  src = /nix/store/7ri4bqz8x0xn3vz6krq1k2rhimkhyxj1-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "generic-lens";
  version = "2.2.2.0";
  src = /nix/store/h7n6i0liv8n3dc0sc48zqjf8dsn96yvd-source;
  libraryHaskellDepends = [
...
;
  http-api-data = {
  meta = {
    sha256 = "0mk0dkfq6rrrw4kh5c4b68ykzaynh2w7gkqbxffs220cbjipapva";
    ver = "0.5.1";
  };
...
mkDerivation {
  pname = "http-api-data";
  version = "0.5.1";
  src = /nix/store/1qfix2d9srw6mpzr8bbahq6q7rx9in35-source;
  libraryHaskellDepends = [
...
;
  http-client = {
  meta = {
    sha256 = "1hr6a1rfksaddw3cvi4g40jq5xn2mxpcd9309v8fxbiw66hbs7bh";
    ver = "0.7.0";
  };
...
mkDerivation {
  pname = "http-client";
  version = "0.7.0";
  src = /nix/store/w4j8lx2nk7spc3bzkyl5kssz2y553axs-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "http-date";
  version = "0.0.11";
  src = /nix/store/68sp6pa0nzhvp47jzg0xm150cx15kig1-source;
...
;
  http-semantics = {
  meta = {
    sha256 = "0jdlakynqm1vm22kb1g1g1mh7h0ihk7mx8l2zzvdaqmqn10lwmh4";
    ver = "0.0.0";
  };
  drv = { mkDerivation, array, base, bytestring, case-insensitive
, http-types, lib, network, network-byte-order, time-manager
...
mkDerivation {
  pname = "http-semantics";
  version = "0.0.0";
  src = /nix/store/4iizp7ga4ixdfnxp52wbylx3wgyn4n09-source;
  libraryHaskellDepends = [
    array base bytestring case-insensitive http-types network
    network-byte-order time-manager utf8-string
  ];
...
mkDerivation {
  pname = "http-types";
  version = "0.12.3";
  src = /nix/store/7kxca4qyfd6wc2j1pl6bh25qvvdvp2lw-source;
  libraryHaskellDepends = [
...
;
  http2 = {
  meta = {
    sha256 = "12zrgymnbsc9ybz1mz0a183vzrpawrsv9hmhhsnrbxqc2im6g52k";
    ver = "5.2.0";
  };
  drv = { mkDerivation, aeson, aeson-pretty, array, async, base
, base16-bytestring, bytestring, case-insensitive, containers
...
mkDerivation {
  pname = "http2";
  version = "5.2.0";
  src = /nix/store/1m78n5ggrrn4s0kh24bpnqp26byz21wd-source;
  isLibrary = true;
  isExecutable = true;
  libraryHaskellDepends = [
    array async base bytestring case-insensitive containers
...
mkDerivation {
  pname = "invariant";
  version = "0.6.3";
  src = /nix/store/4qd8jkk9qxmhhdxnsyq2b3xrfd3ngfpa-source;
  libraryHaskellDepends = [
...
mkDerivation {
  ...
  version = "5.2.6";
  src = /nix/store/5pnhpnc9hb3plimv09fwjh3b6cg43mn4-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "network";
  version = "3.1.2.9";
  src = /nix/store/5hj9nnzbi7gprb1bz2i0a4122k8jzzcg-source;
...
;
  recv = {
  meta = {
    sha256 = "0nsis8kzq86vck8v932c53gp3ci9i0zbkny4il080rd6pxhmq1mm";
    ver = "0.1.0";
  };
...
mkDerivation {
  pname = "recv";
  version = "0.1.0";
  src = /nix/store/4ppr2wbzjhbih7l5c4lvazf5q26x7y00-source;
...
;
  servant = {
  meta = {
    sha256 = "0sfm498h5n0ffwfx6fwrjxif6j34mcy0h91kpq9y3asyaaqw76y2";
    ver = "0.20.1";
  };
...
mkDerivation {
  pname = "servant";
  version = "0.20.1";
  src = /nix/store/jh7n9vcf94jv6i069zx9kqjc1w2p2hgm-source;
  libraryHaskellDepends = [
...
;
  servant-client-core = {
  meta = {
    sha256 = "0yp41xpvzrqazjvmlvfj0hs19ilsxwwsv3bkxzc3kd3i841bbr98";
    ver = "0.20";
  };
  drv = { mkDerivation, aeson, base, base-compat, base64-bytestring
...
mkDerivation {
  ...
  version = "0.20";
  src = /nix/store/c650dprxdwm1x2844zcawwzimsnz5wj5-source;
  libraryHaskellDepends = [
...
;
  servant-server = {
  meta = {
    sha256 = "0ryjsm35qnmkrz9mdm34irvphx0s8898a6kz041akjn6hry09dcj";
    ver = "0.20";
  };
  drv = { mkDerivation, aeson, base, base-compat, base64-bytestring
, bytestring, constraints, containers, directory, exceptions
...
mkDerivation {
  pname = "servant-server";
  version = "0.20";
  src = /nix/store/f6cgl300lpv987p1mc2is4wpkzcf4knv-source;
  isLibrary = true;
  isExecutable = true;
  libraryHaskellDepends = [
...
mkDerivation {
  ...
  version = "0.2.31";
  src = /nix/store/d6crikfa2dv5xbgck3n9cb5iyd3rgjxp-source;
...
mkDerivation {
  ...
  version = "0.4.0.1";
  src = /nix/store/28xm8iv0kg3wlwd74bz3hnbprc71lvv3-source;
...
;
  tasty = {
  meta = {
    sha256 = "0wmnc2538ia9vgz8394hg6wjfd4zxgyfk4k6j5gdhic6hpjfdw7f";
    ver = "1.4";
  };
...
mkDerivation {
  pname = "tasty";
  version = "1.4";
  src = /nix/store/wgal5fswc2gng0bwpac79f685ycp9nhb-source;
  libraryHaskellDepends = [
...
;
  warp = {
  meta = {
    sha256 = "1iskx4vxb3f8b0qfqwxyljgv801sh9jw3kfc1vxxr0j0zlvy3j7r";
    ver = "3.4.0";
  };
...
mkDerivation {
  pname = "warp";
  version = "3.4.0";
  src = /nix/store/4d4jik0cpqhlyiw94hn9r5md8v469q05-source;
  libraryHaskellDepends = [
...
mkDerivation {
  pname = "wide-word";
  version = "0.1.7.0";
  src = /nix/store/59z0v2993flngv9dl89maba7aqay0anr-source;
  libraryHaskellDepends = [
