{
  ...
  overrides = {
    latest = {
      ...
      prelate = {
        version = "0.9.0.2";
        hash = "0pbfaxl06gxkzqbj6f96jf3xv0g59cwawvw4xsw2h8bnszq43zyz";
        repo = "hackage.haskell.org";
      };
      recv = {
        version = "0.1.2";
        hash = "12cs8cibkx6mz6593x708j3wj4iv76ga90sc7v31bg0dzzgphpdd";
        repo = "hackage.haskell.org";
      };
      serialise = {
        version = "0.2.6.1";
      ...
      warp = {
        version = "3.4.16";
        hash = "03sn2vjpy99xhkj7yi80hc00hr7aaskwjypv6crknj1arhc7h4pd";
        repo = "hackage.haskell.org";
      };
      wide-word = {
        version = "0.1.6.0";
